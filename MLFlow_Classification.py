...
def setup(
    ...
    Possible values: "oss", "enn", "random_under", "smoteenn", "smote", "random_over", "smoteenn_maj"
    ...
    allowed_categorical_imputation = ["constant", "mode", "ignore","mice"]
    ...
    allowed_numeric_imputation = ["mean", "median", "ignore","mice"]
    ...
    resampling_method_available = ["oss", "enn", "random_under", "smoteenn", "smote", "random_over","smoteenn_maj"]
...
def tune_model(
  ...
  """
    ...
    #model_results = model_results.append(model_avgs)
    #Fernando Fernandes - 2024-02-12 - Método append tornou-se obsoleto no pandas 2.0
    #Alterado o código para utilizar o método concat
    model_results = pd.concat([model_results,model_avgs])
...
def run_hyperopt_classification(
    ...
    start = time.time()
    trials = Trials()
    #rstate = np.random.RandomState(seed) - Linha substituida devido a obsolescencia
    #Fernando Fernandes - 2024-02-12 - RandomState tornou-se obsoleto
